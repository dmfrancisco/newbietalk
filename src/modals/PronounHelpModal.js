    ...
    <div className="animated bounceInUp w-1/2">
      <div className="Box bg-purple-lightest mb-6">
        ...
        <p className="text-brown leading-normal mx-8 mb-6">
          This answer helps us write more personalized messages. Apart from that, your pronoun will
          be visible to others, and you can see their pronouns too. This and their Avataaar may help
          you decide who you want to chat with.
        </p>
