  ...
  >
    <div className="animated bounce-in-up w-1/2">
      <div className="Box bg-purple-lightest mb-6">
        ...
        <h3 className="text-lg italic m-8 mb-6">
          What languages do you speak?
        </h3>

        <p className="text-brown leading-normal mx-8 mb-6">
          In the first field, we ask you to enter the language you are most
          comfortable with. If you speak other languages, you can add up to 2
          more.
        </p>

        <p className="text-brown leading-normal mx-8 mb-6">
          Next to each text field you may see a flag or a two-letter code. This
          allows us to display country flags in your profile. For example, if
          you’re a proud brazilian that knows portuguese, you can type
          "Portuguese" and pick the flag of Brazil!
        </p>
