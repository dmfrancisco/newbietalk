            ...
            <div className="p-6 pt-4 hyphens">
              ...
              <div className="Message">
                ...
                { stepIndex >= 1 && (
                  <div className="Message-bubble">
                    Hello! So you created a website in your computer and you now want to share it with the world.
                  </div>
                )}
              </div>
              ...
              { stepIndex >= 5 && (
                <div className="Message">
                  ...
                  <div className="Message-bubble">
                    Ok <span role="img" aria-label="Thumbs Up">👍</span>{" "}
                    And just to confirm these are “static” .html and .css files.
                    You don’t have a database or “server” files like .php, right?
                  </div>
                </div>
              )}
              ...
              { stepIndex >= 7 && (
                <div className="Message">
                  ...
                  <div className="Message-bubble">
                    Can I take a look? Maybe we can screenshare.
                    There are many great free tools, but some require you too learn some extra stuff.
                    I can give you some bookmarks and some keywords you can search for if you’re interested.
                  </div>
                </div>
              )}
              ...
              { stepIndex >= 9 && (
                <div className="Message Message--me">
                  <div className="Message-bubble">
                    During my research I found this promising article
              ...
              { stepIndex >= 11 && (
                <div className="Message">
                  <div className="Message-bubble Message-bubble--system">
                    {helper.name} suggested a video chat. If you are too shy,
                    are in a public place or don’t have the hardware, click “Sorry I can’t”.
                  </div>
                </div>
              )}
              ...
              { stepIndex >= 15 && (
                <div className="Message">
                  <div className="Message-bubble Message-bubble--system">
                    ...
                    helped you in any way, be sure to thank {helper.pronoun.split(" ")[2].toLowerCase()}.
                  </div>
                </div>
              )}
              ...
              { stepIndex >= 16 && (
                <div className="Box bg-purple-lightest p-6 text-center m-6 italic leading-normal" style={{ marginRight: "5rem", marginLeft: "5rem" }}>
                  <p className="mb-4">
                    How are you feeling about this conversation? <br />
                    Was {helper.name} friendly and respectful?
                  </p>
                  <p className="mb-4">
                    This feedback is private to you personally.
                  </p>
                  <div className="mb-4 inline-block">
                    <Avatar {...profile.state.avatarStyles } 
                      eyebrowType="SadConcerned" eyeType="Cry" mouthType="Sad" size="3rem"
                      className={"inline-block mr-2" + (stepIndex >= 17 ? " opacity-50" : "")}
                    />
                    <Avatar {...profile.state.avatarStyles }
                      mouthType="Serious" size="3rem"
                      className={"inline-block mr-2" + (stepIndex >= 17 ? " opacity-50" : "") }
                    />
                    <Avatar {...profile.state.avatarStyles }
                      mouthType="Twinkle" size="3rem"
                      className={"inline-block mr-2" + (stepIndex >= 17 ? " opacity-50" : "") }
                    />
                    <Avatar {...profile.state.avatarStyles }
                      eyebrowType="RaisedExcited" eyeType="Hearts" mouthType="Smile"
                      size="3rem" className="inline-block mr-2" />
                  </div>
                  <p>
                    Please, pick one.
                  </p>
