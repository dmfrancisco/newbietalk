        ...
        {profile => (
          <div className="p-6 bg-white">
            ...
            <div className="w-3/4 mx-auto rounded-lg bg-blue-lightest p-6 mb-6">
              ...
              {[0, 1, 2].map((index) => {
                let placeholder;
                if (index === 0) placeholder = "1st language…";
                ...
                return (
                  <div key={index} className="flex">
                    <input
                      ...
                      className="flex-1 border-2 px-3 py-2 h-10 rounded m-1 mr-0"
                      placeholder={placeholder}
                    />

                    <select
                      className="block border-2 h-10 bg-transparent rounded text-xl text-center m-1 mr-0"
